...
query_database_name = "query_database"  #I used 'dbexports' instead of query_database
...
def Q_1(conn, execution_time):
    ...
    query = """SELECT p.player_name, average_xg FROM public.players p
...
def Q_2(conn, execution_time):
    ...
    query = """SELECT p.player_name, ps.shots FROM public.players p
    INNER JOIN public.playerstatistics ps ON p.player_id = ps.player_id
    INNER JOIN public.matches m ON ps.match_id = m.match_id
...
def Q_3(conn, execution_time):
    ...
    query = """SELECT p.player_name, SUM(ps.first_time_shots) AS total_first_time_shots FROM public.players p
    INNER JOIN public.playerstatistics ps ON p.player_id = ps.player_id
    INNER JOIN public.matches m ON ps.match_id = m.match_id
...
def Q_4(conn, execution_time):
    ...
    query = """SELECT t.team_name, passes FROM public.teams t
...
def Q_5(conn, execution_time):
    ...
    query = """SELECT p.player_name, ps.intended_recipient_of_passes FROM public.players p
    INNER JOIN public.playerstatistics ps ON p.player_id = ps.player_id
    INNER JOIN public.matches m ON ps.match_id = m.match_id
...
def Q_6(conn, execution_time):
    ...
    query = """SELECT t.team_name, ts.shots FROM public.teams t
    INNER JOIN public.teamstatistics ts ON t.team_id = ts.team_id
    INNER JOIN public.matches m ON ts.match_id = m.match_id
...
def Q_7(conn, execution_time):
    ...
    query = """SELECT p.player_name, ps.through_balls FROM public.players p
    INNER JOIN public.playerstatistics ps ON p.player_id = ps.player_id
    INNER JOIN public.matches m ON ps.match_id = m.match_id
...
def Q_8(conn, execution_time):
    ...
    query = """SELECT t.team_name, ts.through_balls FROM public.teams t
    INNER JOIN public.teamstatistics ts ON t.team_id = ts.team_id
    INNER JOIN public.matches m ON ts.match_id = m.match_id
...
def Q_9(conn, execution_time):
    ...
    query = """SELECT p.player_name, SUM(ps.successful_dribbles) AS total_successful_dribbles FROM public.players p
    INNER JOIN public.playerstatistics ps ON p.player_id = ps.player_id
    INNER JOIN public.matches m ON ps.match_id = m.match_id
...
def Q_10(conn, execution_time):
    ...
    query = """SELECT p.player_name, ps.dribbled_past FROM public.players p
    INNER JOIN public.playerstatistics ps ON p.player_id = ps.player_id
    INNER JOIN public.matches m ON ps.match_id = m.match_id
