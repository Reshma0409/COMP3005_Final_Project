...
CREATE TABLE IF NOT EXISTS public.playerstatistics (
...
CREATE TABLE If NOT EXISTS public.teamstatistics (
    stat_id integer NOT NULL,
    match_id integer,
    team_id integer,
    passes integer,
...
INSERT INTO public.playerstatistics (stat_id, match_id, player_id, shots, first_time_shots, through_balls, successful_dribbles, dribbled_past, intended_recipient_of_passes, average_xg) VALUES
...
INSERT INTO public.teamstatistics (stat_id, match_id, team_id, passes, through_balls, shots) VALUES
(1, 1, 1, 10200, 80, 320),
(2, 1, 2, 9800, 75, 310),
(3, 1, 3, 9600, 70, 300),
(4, 1, 4, 9400, 65, 290),
